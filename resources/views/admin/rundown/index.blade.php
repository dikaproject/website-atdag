    ...
    <div
        ...
        <div class="w-full mb-1">
            ...
            <div class="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700">
                ...
                <a href="{{ route('admin.products.create') }}"><button id="createProductButton"
                        ...
                        data-drawer-placement="right">Add new product
                    </button></a>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                        <thead class="bg-gray-100 dark:bg-gray-700">
                            <tr>
                                ...
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">ID
                                </th>
                                <th scope="col"
                                    class="p-4 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                                    Slug Product
                            ...
                            @foreach ($products as $product)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <a href="{{ route('admin.products.edit', $product->id) }}"><button type="submit"
                                        ...
                                        <form class="inline-flex" action="{{ route('products.delete_attachments', $product->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-900">
                                        ...
                                        @else
                                        <a href="{{ route('attachments.create', $product->id) }}">
                                            <button type="button"
