...
<body>
    <div class="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        <div class="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
            <h1 class="font-bold text-center text-2xl mb-5">Admin Login</h1>
                ...
                <form action="{{ route('admin_login_submit') }}" method="post">
                    ...
                    <div class="px-5 py-7">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" required/>
                        </div>
                        <div>
                            <label class="font-semibold text-sm text-gray-600 pb-1 block">Password</label>
                            <input type="password" name="password" id="password" class="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" required/>
                        </div>
                        <button type="submit"
